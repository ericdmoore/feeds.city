...
import type { AST as _AST, ASTcomputable, ASTFeedItemJson, ASTjson } from "./parsers/ast.ts";
...
export const isRight = <R, L>(ither: Either<R, L>): ither is Right<R> => !!ither.right;
export const isLeft = <R, L>(ither: Either<R, L>): ither is Left<L> => !!ither.left;
