			...
			{clients.map((client) => (
				<li key={client.id} class="overflow-hidden rounded-xl border border-gray-200">
					<div class="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-6">
						...
						<div as="div" class="relative ml-auto">
							<button class="-m-2.5 block p-2.5 text-gray-400 hover:text-gray-500">
              ...
              > */
							...
							<div class="absolute right-0 z-10 mt-0.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
								...
								<div>
									<a href="#" class="ui-active:bg-gray-50 block px-3 py-1 text-sm leading-6 text-gray-900">
