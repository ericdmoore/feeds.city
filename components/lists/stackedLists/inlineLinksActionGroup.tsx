        ...
        <li key={person.email} class="flex justify-between gap-x-6 py-5">
          ...
          <div class="flex shrink-0 items-center gap-x-6">
            ...
            <Menu as="div" class="relative flex-none">
              <Menu.Button class="-m-2.5 block p-2.5 text-gray-500 hover:text-gray-900">
              ...
              >
                <Menu.Items class="absolute right-0 z-10 mt-2 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                  <Menu.Item>
                      <a
                        href="#"
