...
const company = [
	{ name: "About", href: "#", icon: Information_circle },
	{ name: "Customers", href: "#", icon: Building_office },
	{ name: "Press", href: "#", icon: Newspaper },
	{ name: "Careers", href: "#", icon: Briefcase },
	{ name: "Privacy", href: "#", icon: Shield_check },
];
const resources = [
	{ name: "Community", href: "#", icon: User_group },
	{ name: "Partners", href: "#", icon: Globe_alt },
	{ name: "Guides", href: "#", icon: Bookmark_square },
	{ name: "Webinars", href: "#", icon: Computer_desktop },
];
const blogPosts = [
	{
		id: 1,
