...
export function Stats(props: StatsProps) {
  ...
  return (
    <section class={`bg-${Color.gray}-600 pt-12 sm:pt-16`}>
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-4xl text-center">
          <h2 class="text-3xl font-bold tracking-tight text-gray-100 sm:text-4xl">
            {props?.line1}
          </h2>
          <p class="mt-3 text-xl text-gray-300 sm:mt-4">{props?.line2}</p>
        </div>
      </div>
      <div class="mt-10 bg-white pb-12 sm:pb-16">
        <div class="relative">
          <div class={`absolute inset-0 h-1/2 bg-${Color.gray}-600`} />
