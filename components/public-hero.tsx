...
const CTA = (props: CTAprops) => {
  ...
  const _css = 'class' in props && props.class 
    ...
    ? `flex w-full items-center justify-center rounded-md border border-transparent bg-${props.color.bg}-600 px-8 py-3 font-medium text-${props.color.text} ${props.color.hover ?? `hover:bg--${props.color.bg}-700`} md:py-4 md:px-10 md:text-lg`
