...
const figureTag = (attr:Record<string, string>, ...tagFns: ((that:CompileContext, d:DirectiveInput)=>void)[] )=>(that:CompileContext, d:DirectiveInput)=>{
  that.tag('<figure>')
      ...
      <main>
        ...
        <div class="bg-white px-10 py-32 lg:px-8">
          <div class="mx-auto max-w-6xl text-base leading-7 text-gray-700">
            ...
            <div
              class="markdown-body"
              dangerouslySetInnerHTML={{ __html: micromark(
                data.body,
                { extensions: [
                    // gfm(), 
                    // frontmatter(), 
            ...
            <div class="mt-10 max-w-2xl">
              ...
              <ul role="list" class="mt-8 max-w-xl space-y-8 text-gray-600">
                <li class="flex gap-x-3">
                  ...
                  <span>
                    <strong class="font-semibold text-gray-900">Data types.</strong> Lorem ipsum, dolor sit amet
                ...
                <li class="flex gap-x-3">
                  <Check_circle class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                  <span>
                    <strong class="font-semibold text-gray-900">Loops.</strong> Anim aute id magna aliqua ad ad non
                ...
                <li class="flex gap-x-3">
                  <Check_circle class="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" />
                  <span>
                    <strong class="font-semibold text-gray-900">Events.</strong> Ac tincidunt sapien vehicula erat
