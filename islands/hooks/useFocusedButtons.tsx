...
type ButtonOmisionNames =  'prefix'| 'translate'| 'autocapitalize'| 'style' | 'role'| 'part' | 'form' | 'contentEditable' | 'dir'
...
export function FocusableButton(props: {
    ...
    const cb = function(){   
        ...
        return function(){
            button?.removeEventListener("click", function () { button?.focus() })
