...
import outlineHeroIncons, {type heroProps} from '../components/heroicons/outline.tsx'
...
export function Menu (){
    const solidEntries = Object.entries(solidHeroIncons) as [string, (props: heroProps | undefined)=>JSX.Element][]
    const outlineEntries = Object.entries(outlineHeroIncons) as [string, (props: heroProps | undefined)=>JSX.Element][]
