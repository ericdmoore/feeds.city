...
console.log('\n\nexport const aesGcmJWK = ', JSON.stringify(aesGcmJWK, null, 2))
console.log('\n\nexport const publicRSA = ', JSON.stringify(publicRSA, null, 2))
console.log('\n\nexport const privateRSA = ', JSON.stringify(privateRSA, null, 2))
